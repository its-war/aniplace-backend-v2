...
adminAnimeRouter.put('/alterar',
    ...
    body('dia').optional().escape().isInt().notEmpty(),
    body('ano').optional().escape().isInt().notEmpty().trim(),
    body('disponibilidade').optional().escape().isInt().notEmpty(),
    body('site').optional().escape().trim(),
    body('myanimelist').optional().escape().trim(),
    body('tipo').optional().isInt().escape(),
    body('sinopse').optional().escape().notEmpty().trim(),
    body('temporadaLancamento').optional().isInt().escape(),
    controller.alterar
);
